...
_second = ['的', '一', '是', '了', '我', '不', '人', '在', '他', '有', '这', '个', '上', '们', '来', '到', '时', '大', '地', '为',
           ...
           '乾', '坤']
tel=['134','135','136','137','138','139','182','183','184','187','188','150','151','152','157','158','159','147','148','178','198','133','153','180','181','189','191','199','130','131','132','145','146','155','156','166','175','176','185','186']

if __name__ == '__main__':
    tmp = [np.array(addr), np.array(_first), np.array(_second),np.array(tel)]
    add = np.array(tmp)
    np.save('cst_data.npy', add)
